...
public class FileController {
	...
	@ResponseBody
	public ResponseEntity<Map<String, Object>> getPatientInfo(@RequestParam int no, @RequestParam String studydate) {
	...
	@PostMapping("/viewer")
	public String handleViewerRequest(@RequestParam int pid,
	...
	@GetMapping("/getDicom")
	public ResponseEntity<List<Map<String, Object>>> getFile(@RequestParam int pid, @RequestParam String studydate) {
	    try {
	        // 필요한 필드만 선택하여 쿼리 수행
